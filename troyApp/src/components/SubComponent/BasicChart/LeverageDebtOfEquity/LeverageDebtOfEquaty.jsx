                    ...
                    <Grid item md={4}>
                        <Box className="lower-middle-quartile-sec">
                            ...
                            <div className='bg-white-common gross-margin-sec total-debt'>
                                <Typography variant='h3'>0.55</Typography>
                                <Typography variant='body1'>Total Debt to Capitalization</Typography>
                            </div>
                            <div className='bg-white-common ebitda-margin-sec long-term-debt'>
                                <Typography variant='h3'>0.29</Typography>
                                <Typography variant='body1'>Long Terms Debt to Capitalization</Typography>
                            </div>
                            <div className='bg-white-common net-margin-sec current-debt'>
                                <Typography variant='h3'>0.26</Typography>
                                <Typography variant='body1'>Current Debt to Capitalization</Typography>
                            </div>                           
                        </Box>
                    </Grid>
                    <Grid item md={8}>
...
export default LeverageDebtOfEquaty
